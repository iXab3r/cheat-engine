...
static const char* BBWinVerToString(WinVer v)
{
	switch (v)
	{
	case WINVER_7:            return "WINVER_7";
	case WINVER_7_SP1:        return "WINVER_7_SP1";
	case WINVER_8:            return "WINVER_8";
	case WINVER_81:          return "WINVER_81";
	case WINVER_10_RS1:       return "WINVER_10_RS1";
	case WINVER_10_RS2:       return "WINVER_10_RS2";
	case WINVER_10_RS3:       return "WINVER_10_RS3";
	case WINVER_10_RS4:       return "WINVER_10_RS4";
	case WINVER_10_RS5:       return "WINVER_10_RS5";
	case WINVER_10_19H1:      return "WINVER_10_19H1";
	case WINVER_10_19H2:      return "WINVER_10_19H2";
	case WINVER_10_20H1:      return "WINVER_10_20H1";
	case WINVER_10_20H2:      return "WINVER_10_20H2";
	case WINVER_10_21H2:      return "WINVER_10_21H2";
	case WINVER_10_22H2:      return "WINVER_10_22H2";
	case WINVER_10_23H2:      return "WINVER_10_23H2";
	case WINVER_10_24H2:      return "WINVER_10_24H2";
	default:                  return "WINVER_?";
	}
}
...
static VOID BBPrintDynamicData(_In_ const DYNAMIC_DATA* dd)
{
	if (!dd)
	{
...
/// <summary>
/// Initialize Syscalls index table, must be called before
/// </summary>
