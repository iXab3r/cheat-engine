...
void apic_clearPerfmon()
{
	...
	{
		//LogInfo("Clear perfmon (APIC_BASE at %llx)\n", APIC_BASE);
		//LogInfo("APIC_BASE->LVT_Performance_Monitor.a at %p\n", &APIC_BASE->LVT_Performance_Monitor.a);
		//LogInfo("APIC_BASE->EOI.a at %p\n", &APIC_BASE->EOI.a);

		//LogInfo("APIC_BASE->LVT_Performance_Monitor.a had value %x\n", APIC_BASE->LVT_Performance_Monitor.a);
		//LogInfo("APIC_BASE->LVT_Performance_Monitor.b had value %x\n", APIC_BASE->LVT_Performance_Monitor.b);
//		LogInfo("APIC_BASE->LVT_Performance_Monitor.c had value %x\n", APIC_BASE->LVT_Performance_Monitor.c);
	//	LogInfo("APIC_BASE->LVT_Performance_Monitor.d had value %x\n", APIC_BASE->LVT_Performance_Monitor.d);
